 ...
 */
public class FileMessageJoinListltem extends BaseCustomViewGroup {
    ...
    public FileMessageJoinListltem(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public FileMessageJoinListltem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public FileMessageJoinListltem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public FileMessageJoinListltem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.list_item_status_join_file_message, this);
    }
