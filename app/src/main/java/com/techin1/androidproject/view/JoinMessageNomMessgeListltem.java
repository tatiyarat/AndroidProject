 ...
 */
public class JoinMessageNomMessgeListltem extends BaseCustomViewGroup {
    ...
    public JoinMessageNomMessgeListltem(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public JoinMessageNomMessgeListltem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public JoinMessageNomMessgeListltem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public JoinMessageNomMessgeListltem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.list_item_status_join_gost_non_messge, this);
    }
