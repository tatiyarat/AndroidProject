 ...
 */
public class ViewpagerImageJoinFagment extends Fragment {
    ...
    public ViewpagerImageJoinFagment() {
        super();
    }

    public static ViewpagerImageJoinFagment newInstance() {
        ViewpagerImageJoinFagment fragment = new ViewpagerImageJoinFagment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_viewpager_image_join, container, false);
