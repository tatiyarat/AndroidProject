...
import com.techin1.androidproject.adapter.PhotoListAdapter;
 ...
 */
public class ViewpagerImageMessageFagment extends Fragment {

    ViewPager viewPager;
    PhotoListAdapter imagesListAdapter;
    TextView tvstatus;
    ...
    public ViewpagerImageMessageFagment() {
        super();
    }

    public static ViewpagerImageMessageFagment newInstance() {
        ViewpagerImageMessageFagment fragment = new ViewpagerImageMessageFagment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_viewpager_image_message, container, false);
    ...
    private void initInstances(View rootView) {
        ...
        imagesListAdapter = new PhotoListAdapter(this.getActivity());
