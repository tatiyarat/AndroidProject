...
public class ViewpagerImageActivity extends AppCompatActivity implements ImageStatusFagment.FragmentListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.fragment_img, ViewpagerImageFragment.newInstance())
                    .commit();
        }
