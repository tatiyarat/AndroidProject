...
import com.techin1.androidproject.fragment.ImageFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.flstatus, ImageFragment.newInstance())
                    .commit();
        }
    ...
    private void getJoin(int idu, int ids) {
        ...
        call.enqueue(new Callback<inuserjoinDao>() {
            ...
            public void onResponse(Call<inuserjoinDao> call, Response<inuserjoinDao> response) {
                ...
                if (response.isSuccessful()) {
                    if (dao.getSuccess() == 1) {
                        Toast.makeText(ImagesActivity.this,dao.getJoin()
                                , Toast.LENGTH_LONG)
                                .show();
                    } else {
                        Toast.makeText(ImagesActivity.this,dao.getJoin()
            ...
            public void onFailure(Call<inuserjoinDao> call, Throwable t) {
                Toast.makeText(ImagesActivity.this,"NO..."
                        , Toast.LENGTH_LONG)
                        .show();
            }
        });
